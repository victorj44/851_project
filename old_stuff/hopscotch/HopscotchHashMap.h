...
/////////////////////////////////////////////
//
//MODIFICATION TO MAKE IT COMPILE IN GCC
//original code comes from VS
//
#define _u32 int
	...
	inline_ bool containsKey( const _tKey& key ) {
     ...
     //go over the list and look for key
      ...
      do {
		...
		// Query Operations .........................................................
	inline_ _tData findKey( const _tKey& key ) {
