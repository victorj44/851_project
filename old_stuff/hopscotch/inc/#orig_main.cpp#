...
int main(int argc, char **argv) {
	...
	args[2] = "1";			// Test no.
	args[3] = "4";			// No. threads
	args[4] = "10000";		// No. inserts
	//args[5] = "10000";		// No. deletes
	args[5] = "3";			// Load factor
	args[6] = "10000";		// Initial count
	args[7] = "0";			// Whether or not to time the throughput?
	//read benchmark configuration
	//if(!_gConfiguration.read(argc, argv)) {
	if(!_gConfiguration.read(8, args)) {
